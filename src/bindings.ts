...
export const commands = {
  ...
  async changeOverlayStyleSetting(
    style: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_overlay_style_setting", { style }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeVadEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_vad_enabled_setting", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeNoiseSuppressionEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_noise_suppression_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeShowWhatsNewOnUpdateSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_show_whats_new_on_update_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeWhatsNewLastSeenVersionSetting(
    version: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_whats_new_last_seen_version_setting", {
          version,
        }),
      };
    } catch (e) {
  ...
  async changeTranscribeAcceleratorSetting(
    accelerator: TranscribeAcceleratorSetting,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_transcribe_accelerator_setting", {
          accelerator,
        }),
      };
    } catch (e) {
  ...
  async changeTranscribeGpuDevice(
    device: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_transcribe_gpu_device", { device }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
